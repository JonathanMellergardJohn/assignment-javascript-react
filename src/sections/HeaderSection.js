...
const HeaderSection = ({backgroundcolor}) => {
  return (
    <>
    <header className={"header-section " + backgroundcolor}>
        <nav className="header-container">
            ...
            <label className="hamburger-menu__hamburger" for="hamburger-menu__checkbox"><span className="hamburger-menu__hamb-line"></span></label>
